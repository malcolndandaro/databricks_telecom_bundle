...
# MAGIC # Introduction
# MAGIC
# MAGIC This notebook generates a dataset to serve as a basis for creating geolocation data.
# MAGIC The table `aux_enderecos` was created using a real dataset of ERBs, containing their geolocations. These geolocations were used as reference points to generate nearby fake addresses.
